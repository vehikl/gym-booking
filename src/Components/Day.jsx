...
function Timeslot({ booking, onClick }) {
    ...
    return (
        <div className='whitespace-nowrap flex items-center min-w-0 font-semibold text-gray-700 text-sm cursor-pointer' onClick={onClick}>
    ...
    return (
        <div className={classes}>
            <div className="flex flex-row justify-between">
                ...
                <button onClick={() => onAddBooking({editing: false, id: null})}>                
